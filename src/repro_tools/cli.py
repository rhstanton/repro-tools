...
def compare():
    ...
    parser.add_argument("--reference", type=Path, default="paper", help="Reference directory (default: paper)")
    parser.add_argument("--artifacts", nargs="*", help="Specific artifacts to compare")
    parser.add_argument("--current-dir", type=Path, default="output", help="Current output directory")
