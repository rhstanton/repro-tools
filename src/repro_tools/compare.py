...
def compare_outputs(
    ...
    if all_identical:
        ...
        output_lines.append(
            f"  diff {current_dir}/tables/<artifact>.tex {reference_dir}/tables/<artifact>.tex"
        )
        output_lines.append("\nTo visually compare PDFs:")
        output_lines.append(
            f"  diff-pdf {current_dir}/figures/<artifact>.pdf {reference_dir}/figures/<artifact>.pdf"
        )
